...
SECRET_KEY = 'django-insecure-cvcsp_k1qhjmm^p($e+w1+sa(mk#%i&lf01@&7)s!_bcrns_jp'
...
INSTALLED_APPS = [
    ...
    'crispy_forms',
    'crispy_bootstrap5',
     #added blog app configuration. Viene de blog/apps. Siempre chequear en el apps.py de cada app:
